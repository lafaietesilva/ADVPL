            ...
            for(var a=0;a < datasetPrincipal.rowsCount;a++){
            	...
            	var cardindexdocumentid = datasetPrincipal.getValue(a, "metadata#card_index_id");
            	 ...
            	 if(constraints[0].initialValue==datasetPrincipal.getValue(a,constraints[0].fieldName)){ 
                    ...
                    //Busca o dataset
                    var datasetFilhos = DatasetFactory.getDataset("VM_SolicitacoesEventos", null, constraintsFilhos, null);
                    for (var j = 0; j < datasetFilhos.rowsCount; j++) {
                     	//Adiciona os valores nas colunas respectivamente.
                        dataset.addRow(new Array(
                                documentId,
                                datasetFilhos.getValue(j, "txtproduto"),
                                datasetFilhos.getValue(j, "idquantidadeServ"),
                                datasetFilhos.getValue(j, "vrUnitarioServ"),
                                datasetFilhos.getValue(j, "codigoProdutoServ"),
                                solicitacao
                        ));
                    }
