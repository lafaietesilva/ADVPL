...
function createDataset(fields, constraints, sortFields) {
    ...
    dataset.addColumn("EMAIL_S");
   
    var dados;
    
   var webservice = '/DEPARTAMENTO';
   ...
   var vo = clientService.invoke(JSON.stringify(data));
    ...
    if(dados != null){
    	...
    	objdata = objdata2.DEPARTAMENTOS;
		for(var i in objdata){
			dataset.addRow([objdata[i].CCODIGO, objdata[i].CDESC, objdata[i].CRESP, objdata[i].CEMAILG,objdata[i].CEMAILS]);
		}
	}
