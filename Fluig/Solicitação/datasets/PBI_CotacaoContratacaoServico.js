function createDataset(fields, constraints, sortFields) {
	...
	var formularioSolicitacao = DatasetFactory.getDataset("VM_SolicitacaoContratacoesServico", null, constraintsFormulario, null);


	for (var a = 0; a < formularioSolicitacao.rowsCount; a++) {
		//log.info("dados formulario PBI 1");
		...
		if (formularioSolicitacao.getValue(a, "NumeroContrato") != "" &&
				formularioSolicitacao.getValue(a, "NumeroContrato") != null){
